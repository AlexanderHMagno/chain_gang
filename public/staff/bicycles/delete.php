...
if ($bicycle == false) {
  redirect_to(url_for('/staff/bicyles/index.php'));
}
...
if(is_post_request()) {
  ...
  $session->message('The bicycle '.$bicycle->get_name().' was deleted successfully.');
  redirect_to(url_for('/staff/bicycles/index.php'));
...
<div id="content">
  ...
  <div class="bicycle delete">
    ...
    <p class="item"><?php echo h( $bicycle->get_name()); ?></p>
